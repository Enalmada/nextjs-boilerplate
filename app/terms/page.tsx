    ...
    <Layout title={"Terms"}>
      <Page>
        <section className="prose lg:prose-xl">
            ...
            <li>
              ...
              <ol type="i">
                ...
                <li>
                  ...
                  contained on Technical Challenge&apos;s website;
                </li>
                <li>
          ...
          <ol type="a">
            <li>
              The materials on Technical Challenge&apos;s website are provided
              on an &apos;as is&apos; basis. Technical Challenge makes no
          ...
          <p>
            ...
            or inability to use the materials on Technical Challenge&apos;s
            website, even if Technical Challenge or a Technical Challenge
          ...
          <p>
            ...
            without notice. However Technical Challenge does not make any
          ...
          <p>
            ...
            Technical Challenge of the site. Use of any such linked website is
            at the user&apos;s own risk.
          </p>
          <h3>7. Modifications</h3>
          <p>
            Technical Challenge may revise these terms of service for its
