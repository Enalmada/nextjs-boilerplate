      ...
      <section className="prose lg:prose-xl dark:prose-invert">
        ...
        <ol type="a">
          <li>
            ...
            software) on Technical Challenge&apos;s website for personal, non-commercial transitory
            ...
            <ol type="i">
              ...
              <li>
                attempt to decompile or reverse engineer any software contained on Technical
                Challenge&apos;s website;
              </li>
          ...
          <li>
            ...
            may be terminated by Technical Challenge at any time. Upon terminating your viewing of
        ...
        <ol type="a">
          <li>
            The materials on Technical Challenge&apos;s website are provided on an &apos;as is&apos;
            basis. Technical Challenge makes no warranties, expressed or implied, and hereby
          ...
          <li>
            Further, Technical Challenge does not warrant or make any representations concerning the
        ...
        <h3>4. Limitations</h3>
        <p>
          In no event shall Technical Challenge or its suppliers be liable for any damages
          (including, without limitation, damages for loss of data or profit, or due to business
          interruption) arising out of the use or inability to use the materials on Technical
          Challenge&apos;s website, even if Technical Challenge or a Technical Challenge authorized
        ...
        <p>
          The materials appearing on Technical Challenge&apos;s website could include technical,
          typographical, or photographic errors. Technical Challenge does not warrant that any of
          the materials on its website are accurate, complete or current. Technical Challenge may
          make changes to the materials contained on its website at any time without notice. However
          Technical Challenge does not make any commitment to update the materials.
        </p>
        <h3>6. Links</h3>
        <p>
          Technical Challenge has not reviewed all of the sites linked to its website and is not
          responsible for the contents of any such linked site. The inclusion of any link does not
          imply endorsement by Technical Challenge of the site. Use of any such linked website is at
          the user&apos;s own risk.
        </p>
        <h3>7. Modifications</h3>
        <p>
          Technical Challenge may revise these terms of service for its website at any time without
          notice. By using this website you are agreeing to be bound by the then current version of
          these terms of service.
        </p>
        <h3>8. Governing Law</h3>
        <p>
          These terms and conditions are governed by and construed in accordance with the laws of CA
