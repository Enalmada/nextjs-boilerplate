...
const UploadResponseObject =
	builder.objectRef<UploadResponse>("UploadResponse");
...
const NotificationResponseObject = builder.objectRef<NotificationResponse>(
...
builder.mutationField("publishNotification", (t) =>
	t.fieldWithInput({
		...
		resolve: (root, args, ctx) => {
			...
			return new AdminService().publishNotification(
