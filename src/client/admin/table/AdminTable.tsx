...
import { type TableColumnProps, useTableWrapper } from "@enalmada/nextui-admin";
...
>({
	...
	const { TableWrapperComponent, sortDescriptor, pageDescriptor } =
		useTableWrapper<TEntity>();
